    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-parchment w-full max-w-md rounded-2xl shadow-2xl border-2 border-amber-900/20 overflow-hidden text-amber-900">
            ...
            <div className="p-8 space-y-6">
              <div className="bg-amber-900/5 p-4 rounded-xl border border-amber-900/10 space-y-2">
                ...
                <ol className="text-xs text-amber-800/70 space-y-1 list-decimal ml-4">
                  <li>Deploy your Google Apps Script as a <b>Web App</b>.</li>
              ...
              <div className="flex items-center justify-between p-4 bg-white/50 rounded-xl border border-amber-900/10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold">Sync Enabled</div>
                    <div className="text-[10px] uppercase tracking-tighter opacity-60">Connect to master list</div>
                  </div>
                </div>
                <button 
              ...
              {localConfig.enabled && (
                <div className="space-y-4 animate-in slide-in-from-top-2 duration-200">
                  <div className="space-y-1">
                    <label className="text-xs font-bold uppercase tracking-widest flex justify-between opacity-60">
                    ...
                    <input 
                      ...
                      className="w-full bg-white border-2 border-amber-900/10 rounded-lg p-3 text-sm focus:outline-none focus:border-amber-700"
                    />
                  </div>
                </div>
              )}
              ...
              <p className="text-[10px] text-center opacity-40 uppercase tracking-widest leading-relaxed">
                Tip: Hardcode this URL in constants.ts<br/>to sync automatically for all invitees.
              </p>
            </div>
          </div>
        </div>
